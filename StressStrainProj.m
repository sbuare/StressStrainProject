...
% User inputs
cross_section = input('Is the cross-sectional area circular? [Y/N]\n', 's');
area = input('What is the cross-sectional area of the material? (Hint: probably 2.482 square mm)\n');
